...
\begin{abstract}
  ...
  Dynamic binary instrumentation(DBI) framworks enable the development of
  ...
  developing tools that enhances the security and reliablity of software
  ...
  system, each framework comes with different capabilties and performance
  implications as each framework's design principles varies up to their major
  target applications. However, developers who want to leverage the techonology
  were rarely informed regarding how to choose a framework that meets their
  development goal.

  In this talk, we present an ongoing project that compars three aforementioned
  frameworks by carefully examining three different aspects -- efficeincy,
  capability, and userability. Purpose of our work is to provide a proper
